...
function renderAll() {
  ...
  for (let i = 0; i < _projects__WEBPACK_IMPORTED_MODULE_0__.projectsList.length; i++) {
    ...
    project.addEventListener('click', () => {
      const filteredList = _projects__WEBPACK_IMPORTED_MODULE_0__.projectsList.filter((fList) => fList.id == project.id);
...
function deleteTask() {
  trash.addEventListener('click', (e) => {
    ...
    const index = _projects__WEBPACK_IMPORTED_MODULE_0__.projectsList[projIndex].todos.findIndex((object) => object.id === elementClass);
    // if above breaks try ==
